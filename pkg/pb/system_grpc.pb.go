...
func (c *systemClient) Version(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*VersionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blog.System/Version", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *systemClient) Info(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*InfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blog.System/Info", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _System_Version_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blog.System/Version",
	}
